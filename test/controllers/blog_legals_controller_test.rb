...
class BlogLegalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_legal" do
    assert_difference('BlogLegal.count') do
      post blog_legals_url, params: { blog_legal: { texto: @blog_legal.texto, titulo: @blog_legal.titulo } }
    end
  ...
  test "should update blog_legal" do
    patch blog_legal_url(@blog_legal), params: { blog_legal: { texto: @blog_legal.texto, titulo: @blog_legal.titulo } }
